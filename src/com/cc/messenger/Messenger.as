package com.cc.messenger
{
	...
	public class Messenger
	{
		...
		public function add(messageClass:Class, listener:Function) : void
		{
			...
			{
				DebugUtils.assert(false, "MessageDispatcher: add: failed to create signal for " + className);
			}
		}
		...
		public function remove(messageClass:Class, listener:Function) : void
		{
			...
			{
				LogGatherer.log("Messenger", "MessageDispatcher: remove: no signal for class " + className);
			}
		}
		...
		private static function log(message:String) : void
		{
			CONFIG::debug
			{
				LogGatherer.log("Messenger", "Messenger: " + message);
			}
		}
	}
}